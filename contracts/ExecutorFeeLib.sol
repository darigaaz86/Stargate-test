...
contract ExecutorFeeLib is Ownable, IExecutorFeeLib {
    ...
    function getFee(
        ...
        console.log("ExecutorFeeLib::getFee: start");
        console.log(_dstConfig.lzReceiveBaseGas);
        ...
        console.log("ExecutorFeeLib::getFee: _params.calldataSize is", _params.calldataSize);
        (
            uint256 totalGasFee,
            uint128 priceRatio,
        ...
        console.log("ExecutorFeeLib::getFee: totalGasFee is", totalGasFee);
        console.log("ExecutorFeeLib::getFee: multiplierBps is", multiplierBps);

        fee = _applyPremiumToGas(totalGasFee, multiplierBps, _dstConfig.floorMarginUSD, nativePriceUSD);
        console.log("ExecutorFeeLib::getFee: fee is", fee);
        fee += _convertAndApplyPremiumToValue(totalValue, priceRatio, priceRatioDenominator, multiplierBps);
        console.log("ExecutorFeeLib::getFee: fee after update is", fee);
    }
