...
contract PriceFeed is ILayerZeroPriceFeed, OwnableUpgradeable, Proxied {
    ...
    function _setPrice(uint32 _dstEid, Price memory _price) internal {
        ...
        console.log("PriceFeed::_setPrice: _dstEid", _dstEid);
        console.log("PriceFeed::_setPrice: gasPerByte", gasPerByte);
    ...
    function _estimateFeeWithDefaultModel(
        ...
        console.log("PriceFeed::_estimateFeeWithDefaultModel: _dstEid", _dstEid);
        ...
        console.log("PriceFeed::_estimateFeeWithDefaultModel: _callDataSize", _callDataSize);
        console.log("PriceFeed::_estimateFeeWithDefaultModel: remotePrice.gasPerByte", remotePrice.gasPerByte);
        ...
        console.log("PriceFeed::_estimateFeeWithDefaultModel: gasForCallData", gasForCallData);
        console.log("PriceFeed::_estimateFeeWithDefaultModel: remoteFee", remoteFee);
        console.log("PriceFeed::_estimateFeeWithDefaultModel: remotePrice.priceRatio", remotePrice.priceRatio);
    ...
    function _estimateFeeByEid(
        ...
        console.log("PriceFeed::_estimateFeeByEid: start");
        ...
        if (_modelType == ModelType.OP_STACK) {
            ...
            console.log("PriceFeed::_estimateFeeByEid: _estimateFeeWithDefaultModel");
        ...
        console.log(fee, priceRatio, priceRatioDenominator, priceUSD);
    }
